...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	private List<Institution> institutionList = Lists.newArrayList();
...
//	}
	...
	public List<String> getInstitutionIdList() {
		List<String> institutionIdList = Lists.newArrayList();
		for (Institution institution : institutionList) {
			institutionIdList.add(institution.getId());
		}
		return institutionIdList;
	}

	public void setInstitutionIdList(List<String> institutionIdList) {
		institutionList = Lists.newArrayList();
	...
	public String getInstitutionIds() {
		return StringUtils.join(getInstitutionIdList(), ",");
	}
	
	public void setInstitutionIds(String institutionIds) {
		institutionList = Lists.newArrayList();
		if (institutionIds != null){
			String[] ids = StringUtils.split(institutionIds, ",");
			setInstitutionIdList(Lists.newArrayList(ids));
		}
	}
