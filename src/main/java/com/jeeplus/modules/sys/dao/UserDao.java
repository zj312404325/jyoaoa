...
public interface UserDao extends CrudDao<User> {
	...
	public List<User> findUserByOfficeOrRole(User user);
	...
	public List<String>  findMobileByIds(@Param("userIds")String[] userIds);

	public List<User> searchUserList(Map keyMap);

	public List<User> findAllUserByOfficeId(User user);

	public User getWithJpushId(String id);
}
