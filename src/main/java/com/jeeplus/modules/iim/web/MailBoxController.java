...
public class MailBoxController extends BaseController {
	...
	public String list(MailBox mailBox, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		...
		serachBox.setMail(mailBox.getMail());
		...
		serachBox2.setMail(mailBox.getMail());
	...
	public String delete(MailBox mailBox, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/iim/mailBox/?repage&orderBy=sendtime desc";
	}
