...
public class MyCalendarController extends BaseController {
	...
	public String edit(MyCalendar myCalendar, HttpServletRequest request,
		...
		String e_hour="00";
		String e_minute="00";
		if(FormatUtil.isNoEmpty(request.getParameter("s_hour"))){
			s_hour=request.getParameter("s_hour");
		}
		if(FormatUtil.isNoEmpty(request.getParameter("s_minute"))){
			s_minute=request.getParameter("s_minute");
		}
		if(FormatUtil.isNoEmpty(request.getParameter("e_hour"))){
			e_hour=request.getParameter("e_hour");
		}
		if(FormatUtil.isNoEmpty(request.getParameter("e_minute"))){
			e_minute=request.getParameter("e_minute");
		}
		String s_time = s_hour + ":"
				+ s_minute + ":00";
		String e_time = e_hour + ":"
				+ e_minute + ":00";
