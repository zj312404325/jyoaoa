...
public class ChatHistoryService extends CrudService<ChatHistoryDao, ChatHistory> {
	...
	public List<ChatHistory> findGroupPage(ChatHistory entity) {
		return dao.findGroupLogList(entity);
	}
	...
	public int deleteAllChatHistory(){
		return dao.deleteAllChatHistory();
	}

	public List<ChatHistory> findLogList(ChatHistory entity) {

		return dao.findLogList(entity);
	}
