...
public interface CrudDao<T> extends BaseDao {
	 ...
	 * @return
	 */
	public  List<T> findByProperty(@Param(value="propertyName")String propertyName, @Param(value="value")Object value);
	 ...
	 * @return
	 */
	public  List<Map> findByPropertyMap(@Param(value="propertyName")String propertyName, @Param(value="value")Object value);
}