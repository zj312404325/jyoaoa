...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
    ...
    protected void doUpdate(Session session) {
    	...
    	//System.out.println("update {"+session.getId()+"} {"+(request != null ? request.getRequestURI() : "")+"}");
    ...
    protected Serializable doCreate(Session session) {
		...
		//System.out.println("doCreate {"+session+"} {"+(request != null ? request.getRequestURI() : "")+"}");
    	return session.getId();
    }

    @Override
    protected Session doReadSession(Serializable sessionId) {
    	//System.out.println("readSession {"+sessionId+"} "+(Servlets.getRequest() != null ? Servlets.getRequest().getRequestURI() : "")+"}");
    ...
    public Session readSession(Serializable sessionId) throws UnknownSessionException {
    	try{
    		...
    		//System.out.println("readSession {"+sessionId+"} {"+(request != null ? request.getRequestURI() : "")+"}");
