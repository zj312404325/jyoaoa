...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		top.layer.open({
		    ...
		    content: "${ctx}/tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&notAllowSelectParent=${notAllowSelectParent}&checked=${checked}&extId=${extId}&isAll=${isAll}&selectIds="+$("#${id}Id").val() ,
		    btn: ['确定', '关闭']
