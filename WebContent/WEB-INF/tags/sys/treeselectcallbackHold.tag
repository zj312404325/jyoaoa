...
<%@ attribute name="dataMsgRequired" type="java.lang.String" required="false" description=""%>
	...
	<%-- <div class="input-group">
		<input id="${id}Name" name="${labelName}" ${allowInput?'':'readonly="readonly"'}  type="hidden" value="${labelValue}" data-msg-required="${dataMsgRequired}"
		class="${cssClass}" style="${cssStyle}"/>
       		 添加人员<span class="input-group-btn">
    ...
    <a class="btn btn-primary btn-sm" id="${id}Button"><i class="glyphicon glyphicon-plus"></i> 添加人员</a>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		top.layer.open({
		    ...
		    content: "${ctx}/tag/treeselectHold?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&selectIds="+$("#${id}Id").val() ,
		    btn: ['确定', '关闭']
