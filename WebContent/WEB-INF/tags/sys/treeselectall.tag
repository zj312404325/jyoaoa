...
<%@ attribute name="udata" type="java.lang.String" required="false" description="用户数据"%>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		top.layer.open({
		    ...
		    content: "${ctx}/tag/treeselectall?url="+encodeURIComponent("${url}")+"&module=${module}&notAllowSelectParent=${notAllowSelectParent}&checked=${checked}&extId=${extId}&isAll=${isAll}&selectIds="+$("#${id}Id").val()+"&udata=${udata}" ,
		    btn: ['确定', '关闭']
