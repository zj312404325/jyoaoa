	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
            ...
            $("#uploadF").click(function () {
                var id=$(this).attr("vl");
                commonFileUpload(id,"muti","pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document");
            });
        ...
        function commonFileUploadCallBack(id,url,fname){
            if(url!=null){
                $.each(url,function (i,n) {
                    $("#filecontent").append('<li class="inline_box"><a class="inline_two" href="javascript:" vl="'+n.fileUrl+'" vl2="'+n.fileName+'" onclick="commonFileDownLoad(this)">'+n.fileName+'</a> &nbsp; <a href="javascript:" name="furl" vl="'+n.fileUrl+'" vl2="'+n.fileName+'"><i class="glyphicon glyphicon-remove text-danger"></i></a></li>');
                })
            }
            totalUrl();
        }
        function totalUrl() {
            var urls = "";
            var titles = "";
            $("#filecontent").find("a[name=furl]").each(function(i,n){
                var obj = $(this);
                if(i==0){
                    urls+=obj.attr("vl");
                    titles+=obj.attr("vl2");
