            ...
            <div class="col-sm-9 animated fadeInRight">
                <div class="mail-box-header">
                    ...
                    <div class="mail-tools tooltip-demo m-t-md">
                        ...
                        <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="left" onclick="reset()" title="刷新邮件列表"><i class="fa fa-refresh"></i> 刷新</button>
                        ...
                        <tbody>
                        	...
                        	<c:forEach items="${page.list}" var="mailBox">
								<tr>
	                                ...
	                                <td>
		                                <a href="${ctx}/iim/mailBox/detail?id=${mailBox.id}" onclick="parent.changeOaNotifyCount('${mailBox.id}',1)">
	                                ...
	                                <td class=""><a href="${ctx}/iim/mailBox/detail?id=${mailBox.id}" onclick="parent.changeOaNotifyCount('${mailBox.id}',1)">
    ...
    <script>
	   ...
	   function search(){//查询，页码清零
		...
		function reset(){//重置，页码清零
			$("#pageNo").val(0);
			$("#searchForm div.input-group input").val("");
			$("#searchForm div.input-group select").val("");
			$("#searchForm").submit();
	  		return false;
	 	 }
