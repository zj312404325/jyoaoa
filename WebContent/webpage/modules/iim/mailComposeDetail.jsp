            ...
            <div class="col-sm-9 animated fadeInRight">
                <div class="mail-box-header">
                    <div class="pull-right tooltip-demo">
                        ...
                        <%-- <a href="${ctx}/iim/mailCompose/replyLetter?id=${mailCompose.id}" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="回复"><i class="fa fa-reply"></i> 回复</a> --%>
                        <!-- <a href="#" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="打印邮件"><i class="fa fa-print"></i> </a> -->
                        <a href="javascript:;" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="删除邮件" onclick="return confirmx('确认要删除该站内信吗？', '${ctx}/iim/mailCompose/delete?id=${mailCompose.id}')"><i class="fa fa-trash-o"></i> </a>
                    </div>
                    <h2>
                    查看邮件
                </h2>
                ...
                <div class="mail-box">
                    ...
                    <div class="mail-body text-right tooltip-demo">
                        <%-- <a class="btn btn-sm btn-white" href="${ctx}/iim/mailCompose/replyLetter?id=${mailCompose.id}"><i class="fa fa-reply"></i> 回复</a> --%>
                       <!--   <a class="btn btn-sm btn-white" href="#"><i class="fa fa-arrow-right"></i> 下一封</a>
                        ...
                        <button title="" onclick="return confirmx('确认要删除该站内信吗？', '${ctx}/iim/mailCompose/delete?id=${mailCompose.id}')"  data-placement="top" data-toggle="tooltip" data-original-title="删除邮件" class="btn btn-sm btn-white"><i class="fa fa-trash-o"></i> 删除</button>
                    </div>
                    <div class="clearfix"></div>
