	...
	<script type="text/javascript">
	    ...
	    function searchFriend(layGroupId){
			top.layer.open({
			    ...
			    title:"添加好友",
			    name:'friend',
			    content: "${ctx}/iim/contact/searchUsers?type=2&layGroupId="+layGroupId ,
			    btn: ['确定', '关闭'],
            ...
            <c:forEach items="${layGrouplist}" var="layGroup">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                    	 <c:if test="${layGroup.avatar!=null&&layGroup.avatar!=''}"><a href="#"><img alt="member" class="img-circle" src="${layGroup.avatar.split(",")[0]}" width="50px" height="50px">
                            ${layGroup.groupname}</a></c:if>
                            <c:if test="${layGroup.avatar==null||layGroup.avatar==''}"><a href="#"><img alt="member" class="img-circle" src="${layGroup.avatar}" width="50px" height="50px">
                            ${layGroup.groupname}</a></c:if>
                    ...
                    <div class="ibox-content">
                        <div class="team-members clearfix">
                         	 ...
                         	 <c:if test="${layGroup.createBy.name == fns:getUser().name}">
                         	 	<a href="#" style="float:left" onclick="searchFriend('${layGroup.id}')"><img  class="img-circle" src="${ctxStatic}/images/add_user.jpg">
                         			添加</a>
							</c:if>					
                        </div>
                        <h4>群组简介</h4>
