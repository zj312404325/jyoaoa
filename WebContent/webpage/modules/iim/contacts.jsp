                    ...
                    <div class="ibox-content">
                        ...
                        <!-- <p>
                          可以向通讯录中的人发送，站内信，短消息和发起会话。
                        	...
                        	<form:form id="searchForm" modelAttribute="user" action="${ctx}/iim/contact/index" method="post" class="form-inline">
                                <div class="form-group">
                                    <label>联系人：</label>
                                    <form:input path="keywords" htmlEscape="false" maxlength="50" placeholder="查找联系人" class="input form-control"/>
                                    <label>联系电话：</label>
                                    <form:input path="mobile" htmlEscape="false" maxlength="50" placeholder="查找联系电话" class="input form-control"/>
                                </div>
                                <div class="form-group">
                                <label>部门：</label>
                                    <sys:treeselect id="searchparent" name="searchparentid" value="${user.searchparentid}" labelName="searchparentname" labelValue="${user.searchparentname}"
