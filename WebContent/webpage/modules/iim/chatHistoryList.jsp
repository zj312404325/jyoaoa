...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#delChatHistory").click(function(){

                layer.confirm('确定删除此聊天记录？', {
                    btn: ['提交','取消'], //按钮
                    shade: false //不显示遮罩
                }, function(index){
                    var iload = layer.load(0, {shade: false});
                    $.post("${ctx}/iim/chatHistory/deleteMyChatHistory",
                        {
                            "userid1":"${chatHistory.userid1 }",
                            "userid2":"${chatHistory.userid2 }",
                            "type":"friend"
                        },function(data){
                            layer.close(iload);
...
<body>
	 ...
	 <div class="wrapper wrapper-content  animated fadeInRight">
                            ...
                            <div class="col-md-12 ">
								...
								<c:forEach items="${page.list}" var="chatHistory">
									...
									<div class="chat-message chat-message-left">
                                        <img class="message-avatar" src="${basePath}${fns:getByLoginName(userid1).photo}" alt="">
                                        <div class="message">
		 ...
		 <p style="clear:both;" class="text-right"><a href="javascript:" id="delChatHistory"><i class="glyphicon glyphicon-trash"></i>&nbsp;清理聊天记录</a></p>
    </div>
