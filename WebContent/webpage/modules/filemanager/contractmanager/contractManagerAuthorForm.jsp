	...
	<form:form id="inputForm" modelAttribute="contractManager" action="${ctx}/contractmanager/contractManager/save" method="post" class="form-horizontal">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   ...
		   <tr>
			   ...
			   <td class="width-35">
							<span id="userarea" ><sys:treeselect id="receiveuser" name="receiveuserids" value="${contractManager.receiveuserids}" labelName="receiveusernames" labelValue="${contractManager.receiveusernames}"
