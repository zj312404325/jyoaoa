...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="planfundSearch" action="${ctx}/contractmanager/planfundSearch/list?fundnature=2" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column planfundname">计划付款名称</th>
				...
				<th  class="sort-column money">计划付款金额</th>
				<th  class="">余额</th>
				<th  class="">完成比例</th>
				<th  class="">逾期（天）</th>
				<!-- <th>操作</th> -->
