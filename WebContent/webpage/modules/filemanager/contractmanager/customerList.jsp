...
<head>
	...
	<script type="text/javascript">
		...
		function add(){
			openDialog("新增客户信息","${ctx}/filemanagement/customer/form?usertype=${usertype}","950px", "80%","");
		}
	</script>
</head>
<body class="gray-bg">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<!-- <th  class="sort-column customerclassid">客户类别id</th> -->
				...
				<!-- <th  class="sort-column customerlevelid">客户级别id</th> -->
				<th  class="sort-column customerlevel">客户级别</th>
			...
			<tr>
				...
				<td>
					<shiro:hasPermission name="filemanagement:customer:view">
						<a href="#" onclick="openDialogView('查看信息', '${ctx}/filemanagement/customer/view?id=${customer.id}&usertype=${customer.usertype}','950px', '80%')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="filemanagement:customer:edit">
    					<a href="#" onclick="openDialog('修改信息', '${ctx}/filemanagement/customer/form?id=${customer.id}&usertype=${customer.usertype}','950px', '80%')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="filemanagement:customer:del">
					...
					<shiro:hasPermission name="filemanagement:customer:edit">
						<a href="#" onclick="openDialog('授权信息', '${ctx}/filemanagement/customer/authorform?id=${customer.id}','950px', '50%')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 授权</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
