...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="actualfundSearch" action="${ctx}/contractmanager/actualfundSearch/list?fundnature=1" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="actualfundSearch">
			<tr>
				...
				<td>
					${actualfundSearch.customerclass}
				</td>
				<td>
