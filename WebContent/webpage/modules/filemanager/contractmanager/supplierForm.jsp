	...
	<form:form id="inputForm" modelAttribute="customer" action="${ctx}/filemanagement/customer/save" method="post" class="form-horizontal">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
				    <td class="width-15 active" colspan="4"><label class="pull-right">供应商类别：</label></td>
					<td colspan="6" class="width-35">
					...
					<td colspan="6" class="width-35">
						<form:input path="industry" htmlEscape="false"    class="form-control " maxlength="20"/>
					</td>
				</tr>
				<%-- <tr>
					<td class="active" colspan="4"><label class="pull-right">供应商类别：</label></td>
					<td colspan="6">
						<form:select path="customerclassid"  class="form-control m-b">
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('customerclass')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</td>
				...
				<%-- <tr>
					...
					<td class="width-15 active"><label class="pull-right">供应商级别id：</label></td>
					<td class="width-35">
				...
				<tr>
					...
					<td colspan="6">
						<form:input path="residence" htmlEscape="false"    class="form-control " maxlength="30"/>
					</td>
				...
				<tr>
					...
					<td colspan="6">
						<form:input path="businessscope" htmlEscape="false"    class="form-control " maxlength="20"/>
					</td>
				...
				<tr>
					...
					<td colspan="6">
						<form:input path="bankno" htmlEscape="false"    class="form-control " maxlength="20"/>
					</td>
				</tr>
				<tr>
		...
		<div class="tabs-container">
			...
			<script type="text/template" id="customerFileTpl">//<!--
				<tr id="customerFileList{{idx}}">
					...
					<td>
						<input id="customerFileList{{idx}}_filename" name="customerFileList[{{idx}}].filename" type="text" value="{{row.filename}}"    class="form-control required" maxlength="200"/>
					</td>
					...
					<td>
						<!-- <input id="customerFileList{{idx}}_fileclassid" name="customerFileList[{{idx}}].fileclassid" type="hidden" value="{{row.fileclassid}}" class="form-control "/>
					...
					<td>
						<input id="customerFileList{{idx}}_fileurl" name="customerFileList[{{idx}}].fileurl" type="text" value="{{row.fileurl}}"    readonly="true"  class="form-control required" placeholder="点击上传附件" onclick="commonFileUpload('customerFileList{{idx}}_fileurl');" maxlength="500"/>
					</td>
