		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
			   <tr>
				   ...
				   <td class="width-35">
							<span id="userarea" ><sys:treeselect id="receiveuser" name="receiveuserids" value="${customer.receiveuserids}" labelName="receiveusernames" labelValue="${customer.receiveusernames}"
