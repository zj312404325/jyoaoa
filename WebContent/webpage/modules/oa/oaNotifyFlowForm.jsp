...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			//$('#content').val($('#formdata').html());
			$('#content').summernote({
                lang: 'zh-CN',
                toolbar: [["style", ["style"]], ["font", ["bold", "italic", "underline", "clear"]], ["fontname", ["fontname"]], ["color", ["color"]], ["para", ["ul", "ol", "paragraph"]], ["height", ["height"]], ["table", ["table"]]]
            });
...
<body class="hideScroll">
		      	...
		      	<tr>
				         ...
				         <td class="width-35" colspan="3">
				            <table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
								...
								<span class="pull-right" style="padding-bottom: 5px;"><sys:treeselectcallback id="oaNotifyRecord" name="oaNotifyRecordIds" value="${oaNotify.oaNotifyRecordIds}" labelName="oaNotifyRecordNames" labelValue="${oaNotify.oaNotifyRecordNames}"
   ...
   <%-- <div id="formdata" style="display: none;">
    <div class="row">
       <p style="font-size: 16px;">&nbsp;&nbsp;&nbsp;&nbsp;<b>${flowtemplate.templatename}</b></p>
