...
<head>
	...
	<script type="text/javascript">
		...
		function addit(){
			location.href="${ctx}/flow/flowtemplate/form?templatetype=${templatetype}";
		}
		function editit(){
...
<body class="gray-bg">
	...
	<div class="ibox-title">
		<c:if test="${templatetype == 0}"><h5>流程模板创建列表 </h5></c:if>
		<c:if test="${templatetype == 1}"><h5>申请模板创建列表 </h5></c:if>
	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="flow:flowtemplate:add">
		...
		<c:forEach items="${page.list}" var="flowtemplate">
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="flow:flowtemplate:edit">
    					<a href="${ctx}/flow/flowtemplate/form?id=${flowtemplate.id}&templatetype=${flowtemplate.templatetype}" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="flow:flowtemplate:del">
