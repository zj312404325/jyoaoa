    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-sm-8">
            <div class="title-action">
                <a href="javascript:" class="btn btn-success">保存设计</a>
                <a href="javascript:" class="btn btn-danger">清空连接</a>
            </div>
        </div>
    </div>
...
//	                               }
	                            ...
	                            //},'json');
								var data = {"id":"61","flow_id":"4","process_name":"\u53d1\u8d77\u7533\u8bf7","process_to":"63,64","icon":"glyphicon-ok","style":"width:121px;height:41px;color:#0e76a8;left:"+ mLeft +";top:"+ mTop +";"};
