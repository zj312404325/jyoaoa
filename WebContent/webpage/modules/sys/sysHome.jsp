...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
		<!-- <div id="indexBox" style="color:#909294; font-size:60px; font-family:'Microsoft Yahei'; font-weight:bold; letter-spacing:10px; max-width:none;" class="middle-box text-center animated fadeInDownBig">欢迎使用<br/>OA办公自动化管理系统</div> -->
   
   		<div id="indexBox" style="color:#909294; font-size:50px; font-family:'Microsoft Yahei'; font-weight:bold; letter-spacing:10px; max-width:none;" class="middle-box text-center animated fadeInDownBig">欢迎进入${fns:getConfig('productName')}<br/><span class="<c:if test="${!isNew}">hidden</c:if>">请先完成入职登记</span><br/><a class="frameItem" href="javascript:" vl="${ctx}/ehr/entry/form" vl2="入职登记" data-index="7788" ><button type="button" class="btn btn-primary <c:if test="${!isNew}">hidden</c:if>" style="padding:6px 24px; font-size:20px;">去完成</button></a><p class="text-center"><c:if test="${!isOnline}"><img src="${ctxStatic}/images/test_app_download.png" alt="OA安卓版" title="OA安卓版" width="10%" style="display: none" /></c:if><c:if test="${isOnline}"><img src="${ctxStatic}/images/app_download.png" alt="OA安卓版" title="OA安卓版" width="10%" style="display: none;" /></c:if></p><p class="text-center" style="font-size: 14px; line-height: 30px;display: none ">目前只支持内部网络使用</p></div>
