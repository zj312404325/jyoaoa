		...
		<tbody>
			<c:forEach items="${list}" var="role">
				<tr>
					...
					<td style="display: none;">${fns:getDictLabel(role.useable,'yes_no', '')}</td>
					<td>
						...
						<c:if test="${role.islock==null||role.islock=='0' }">
						<shiro:hasPermission name="sys:role:edit"> 
						...
						<a href="#" onclick="openDialog('权限设置', '${ctx}/sys/role/auth?id=${role.id}','350px', '80%')" class="btn btn-primary btn-xs" ><i class="fa fa-edit"></i> 权限设置</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="sys:role:assign"> 
						...
						<%--<shiro:hasPermission name="sys:role:institution">
						<a href="#" onclick="openDialog('制度管理', '${ctx}/sys/institution/auth?id=${role.id}','350px', '80%')" class="btn btn-info btn-xs" ><i class="fa fa-edit"></i> 制度管理</a>
						</shiro:hasPermission>--%>
						</td>
				</tr>
			</c:forEach>
