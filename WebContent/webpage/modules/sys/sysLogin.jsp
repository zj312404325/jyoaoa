					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="center">
								<h1>
									<br/>
									<%-- <img src="${ctxStatic }/common/login/images/LOGO_OA.png" style="width:280px"> --%>
									<br>
								</h1>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text"  id="username" name="username" class="form-control required"  value="${oajyuname }" placeholder="用户名" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="password" name="password" value="${oajypwd }" class="form-control required" placeholder="密码" />
													...
													<div class="clearfix">
														<label class="inline">
															...
															<%-- <input  type="checkbox" id="rememberMe" name="rememberMe" ${rememberme=='1' ? 'checked' : ''} class="ace" /> --%>
							...
							<%--<div class="center"><h4 id="id-company-text"><font color="#A90E0E">&copy; www.jinying365.com</font></h4></div>--%>
