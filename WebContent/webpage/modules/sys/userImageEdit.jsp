...
<body class="hideScroll">
                            ...
                            <div id="uploader" class="wu-example">
                                ...
                                <div class="statusBar" style="display:none;">
                                    ...
                                    <div class="btns">
                                        ...
                                        <div class="btn btn-success uploadBtn2" style="display: none" onclick="javascript:window.parent.layer.closeAll();">关闭</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    jQuery(function() {
        ...
        uploader.onError = function( code ) {
            //alert( 'Eroor: ' + code );
            //if(code == 'Q_EXCEED_SIZE_LIMIT' || code == 'Q_TYPE_DENIED'){
                alert( '请上传1M以内的图片，谢谢！');
           // }
        };
