...
<body>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/modifyPwd"  method="post" class="form-horizontal form-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="newPassword" name="newPassword" type="password" value="" maxlength="50" minlength="3" class="form-control  max-width-250 required isPassWord"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			...
			<input id="btnSubmit" class="btn btn-primary" type="submit" style="<c:if test="${hasBtn == null}">display:none</c:if>" value="保 存"/>
		</div>
	</form:form>
</body>
</html>