	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#userPassWordBtn").click(function(){
				...
				openDialog("修改密码","${ctx}/sys/user/modifyPwd","800px", "500px","");
			});
			...
			$("#userInfoBtn").click(function(){
				...
				/* openDialog("个人资料编辑","${ctx}/sys/user/infoEdit","800px", "500px",""); */
			});
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-sm-4" style="margin-bottom: 10px;">
									<img alt="image" class="img-responsive" src="${basePath}${user.photo }" />
								</div>
								<div class="col-sm-8">
