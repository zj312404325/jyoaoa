  ...
  <head>
	...
	$(function(){
		...
		$("#addFile").click(function(){
		    $(this).closest("table").find("tr:last").after('<tr><td><input type="file" onchange="getPhotoSize(this)" accept="application/${filetype}" name="fileUploade"  style=" border:1px solid skyblue;" /></td><td><a href="javascript:" onclick="delFile(this)"><i class="glyphicon glyphicon-remove text-danger"></i></a></td></tr>')
        });
  ...
  <div style="padding:10px;">
    ...
    <form onsubmit="return vd();" id="fff" name="fileForm" action="" method="post" enctype="multipart/form-data">
        <table class="table" style="border:none" id="fileTable">
            <tr>
                <td><input type="file" onchange="getPhotoSize(this)"  accept="application/${filetype}" name="fileUploade" style=" border:1px solid skyblue;" /></td>
