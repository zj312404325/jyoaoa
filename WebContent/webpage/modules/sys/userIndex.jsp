...
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="userContent" name="userContent" src="${ctx}/sys/user/list?isAdmin=1" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
	<script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#userContent').attr("src","${ctx}/sys/user/list?isAdmin=1&office.id="+id+"&office.name="+officename);
				}
			}
		};
