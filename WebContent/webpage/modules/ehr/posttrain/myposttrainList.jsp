...
<body class="hideScroll">
	...
	<sys:message content="${message}"/>
					...
					<form:form id="searchForm" modelAttribute="posttrain" action="${ctx}/ehr/posttrain/mylist" method="post" class="form-inline">
							...
							<c:forEach items="${page.list}" var="posttrain">
								<tr>
									...
									<td>
										...
										<shiro:hasPermission name="ehr:posttrain:edit">
					    					<a href="#" onclick="openDialog('修改信息', '${ctx}/ehr/posttrain/form?id=${posttrain.id}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
					    				</shiro:hasPermission>
					    				<%-- <shiro:hasPermission name="ehr:posttrain:del">
