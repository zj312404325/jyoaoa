	        	...
	        	<div class="tab-content" style="height:100%">
	            	<div id="tab-1" class="tab-pane <c:if test="${type!=null&&type=='0' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe1" src="${ctx }/checkmodel/performanceCheck/list?${repage}&category=${performanceCheck.category}" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	                <div id="tab-2" class="tab-pane <c:if test="${type!=null&&type=='1' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe2" src="${ctx }/checkmodel/performanceCheck/list?${repage}&cat=recieve&category=${performanceCheck.category}" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	           	</div>
...
<%-- <div id="keyContent">
	...
	<div id="div_basic" style="height:100%">
		...
		<c:if test="${type!=null&&type=='1' }"><iframe id="contentIframe" src="${ctx }/checkmodel/performanceCheck/list?cat=recieve" style="width:100%;height:100%"></iframe></c:if>
	</div>
</div> --%>
...
$(function(){
	...
	$("#span_recieve").click(function(){
		$("#contentIframe").attr("src","${ctx }/checkmodel/performanceCheck/list?cat=recieve");
	}); */
})
