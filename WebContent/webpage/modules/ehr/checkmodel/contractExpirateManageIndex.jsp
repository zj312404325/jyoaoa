		...
		<div class="ibox-content" style="height:100%">
			<div class="tabs-container" id="keyContent" style="height:100%">
	        	<ul class="nav nav-tabs">
	                <li class="<c:if test="${type!=null&&type=='0' }">active</c:if>"><a data-toggle="tab" href="#tab-1" aria-expanded="true">合同到期提醒</a>
	                </li>
	                <li class="<c:if test="${type!=null&&type=='1' }">active</c:if>"><a data-toggle="tab" href="#tab-2" aria-expanded="false">合同到期人员考核表</a>
	                </li>
	            </ul>
	        	<div class="tab-content" style="height:100%">
	            	<div id="tab-1" class="tab-pane <c:if test="${type!=null&&type=='0' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe1" src="${ctx }/checkmodel/contractExpirate/contractWarnninglist" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	                <div id="tab-2" class="tab-pane <c:if test="${type!=null&&type=='1' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe2" src="${ctx }/checkmodel/contractExpirate/managerlist" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	           	</div>
