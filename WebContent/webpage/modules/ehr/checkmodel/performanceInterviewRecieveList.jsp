...
<body class="hideScroll">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="performanceInterview" action="${ctx}/checkmodel/performanceInterview/list?category=recieve" method="post" class="form-inline">
			...
			<tr>
				...
				<td>
					<shiro:hasPermission name="checkmodel:performanceInterview:view">
						<a href="#" onclick="openDialog('查看绩效考核面谈表(${performanceInterview.username})', '${ctx}/checkmodel/performanceInterview/form?id=${performanceInterview.id}&type=1','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<%-- <shiro:hasPermission name="checkmodel:performanceInterview:edit">
