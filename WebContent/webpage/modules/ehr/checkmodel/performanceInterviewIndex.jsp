	        	...
	        	<div class="tab-content" style="height:100%">
	            	<div id="tab-1" class="tab-pane <c:if test="${type!=null&&type=='0' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe1" src="${ctx }/checkmodel/performanceInterview/list?${repage}" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	                <div id="tab-2" class="tab-pane <c:if test="${type!=null&&type=='1' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe2" src="${ctx }/checkmodel/performanceInterview/list?category=recieve&${repage}" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	           	</div>
...
<%-- <div id="keyContent">
	...
	<div id="div_basic" style="height:100%">
		<c:if test="${type!=null&&type=='0' }"><iframe id="contentIframe" src="${ctx }/checkmodel/performanceInterview/list" style="width:100%;height:100%"></iframe></c:if>
		<c:if test="${type!=null&&type=='1' }"><iframe id="contentIframe" src="${ctx }/checkmodel/performanceInterview/list?category=recieve" style="width:100%;height:100%"></iframe></c:if>
	</div>
</div> --%>
...
$(function(){
	...
	$("#span_send").click(function(){
		$("#contentIframe").attr("src","${ctx }/checkmodel/performanceInterview/list");
	});
	
	$("#span_recieve").click(function(){
		$("#contentIframe").attr("src","${ctx }/checkmodel/performanceInterview/list?category=recieve");
	}); */
})
