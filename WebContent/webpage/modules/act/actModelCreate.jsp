...
<body>
	...
	<form id="inputForm" action="${ctx}/act/model/create"  method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="name" name="name" type="text" class="form-control required" value="${md.name }" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="key" name="key" type="text" class="form-control required" value="${md.key }"/>
				<span class="help-inline"></span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<textarea id="description" name="description" class="form-control required">${descript }</textarea>
			</div>
		</div>
	</form>
</body>
