...
<table class="table table-striped table-bordered ">
	...
	<c:forEach items="${histoicFlowList}" var="act">
		<c:if test="${act.END_TIME_ !=null}">
			<td id="start" style="width:80px;text-align:center;background-color:#5BA276;"><span style="color:#FFFFFF;">${act.ACT_NAME_}>></span></td>
		</c:if>
		<c:if test="${act.END_TIME_ ==null}">
			<td id="start" style="width:80px;text-align:center;background-color:red;"><span style="color:#FFFFFF;">${act.ACT_NAME_}</span></td>
		</c:if>
	</c:forEach>
</table>