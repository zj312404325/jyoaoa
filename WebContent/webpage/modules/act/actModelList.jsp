	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="act:model:create">
				<table:addRow url="${ctx}/act/model/create"  title="模型"></table:addRow><!-- 增加按钮 -->
			</shiro:hasPermission>
			<shiro:hasPermission name="oa:oaNotify:edit">
			    <table:editRow url="${ctx}/act/model/create" id="contentTable"  title="模型" width="800px" height="700px"></table:editRow><!-- 编辑按钮 -->
			</shiro:hasPermission>
