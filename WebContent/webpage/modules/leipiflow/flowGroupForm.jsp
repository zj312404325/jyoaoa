		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         ...
		         <td class="width-35" ><input type="text" id="groupname" name="groupname" htmlEscape="false" maxlength="200" class="form-control required"/></td>
		      </tr>
		   </tbody>
		</table>
		<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
			<span class="pull-right" style="padding-bottom: 5px;"><sys:treeselectcallbackHold id="oagroup" name="oagroupids" value="" labelName="oagroupnames" labelValue=""
