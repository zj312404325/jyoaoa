...
<head>
	...
	function page(n,s){
        	location = '${ctx}/leipiflow/leipiFlowApply/myLeipiFlowByIds?isadmin=${isadmin}&flowid=${flowid}&pageNo='+n+'&pageSize='+s;
        }
	</script>
</head>
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="flowapply" action="${ctx}/leipiflow/leipiFlowApply/myLeipiFlowByIds?isadmin=${isadmin}&flowid=${flowid}" method="get" class="form-inline">
		...
		<tbody>
			<c:forEach items="${page.list}" var="map">
				...
				<tr>
					...
					<td>
						<a href="#" onclick="openDialogView('查看我的申请-${fns:abbr(map.leipiFlow.flowname,16)}', '${ctx}/leipiflow/leipiFlowApply/myLeipiView?id=${map.id}&flag=1','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
