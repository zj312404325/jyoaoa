	        	...
	        	<div class="tab-content" style="height:100%">
	            	<div id="tab-1" class="tab-pane <c:if test="${type!=null&&type=='0' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe1" src="${ctx }/leipiflow/templateDetail/list?flowid=${flowid}" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	                <div id="tab-2" class="tab-pane <c:if test="${type!=null&&type=='1' }">active</c:if>" style="height:100%">
	                    <div class="panel-body" style="height:100%">
	                    	<iframe id="contentIframe2" src="${ctx }/leipiflow/templateDetail/list?flowid=${flowid}&mtd=recieve" style="width:100%;height:100%" frameborder="0"></iframe>
	                    </div>
	                </div>
	           	</div>
